...
int subtractionResult = 5 - 2; // - is our subtraction operator
Console.WriteLine("5 - 2 = " + subtractionResult);

int multiplicationResult = 5 * 2; // * is our multiplication operator
Console.WriteLine("5 * 2 = " + multiplicationResult);

double divisionResult = (5 / 2.0); // / is our division operator
Console.WriteLine("5 / 2 = " + divisionResult);

int modulusResult = 5 % 2; // % is our modulus (remainder) operator
